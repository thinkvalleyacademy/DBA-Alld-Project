...
const YEAR_OPTIONS = Array.from({ length: 10 }, (_, i) => currentYear - 7 + i);
...
const GMVoterList = () => {
  ...
  return (
    <div>
      ...
      <VoterTable
        type="gm"
        title="General Member Voter List"
        fetchFunction={apiService.gmList}
        searchFunction={apiService.gmSearch}
